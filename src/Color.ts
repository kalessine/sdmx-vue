 ...
 */
class Color {
    private rgb: number[]|undefined=undefined;
    private hsl: HSL|undefined=undefined;
    private readonly a: number|undefined=undefined;
     ...
     *
     */
    lightness(lightness: number): Color|undefined {
